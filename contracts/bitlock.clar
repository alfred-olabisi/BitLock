;; BitLock Protocol: Bitcoin-Native Staking & Governance
;; A decentralized staking and governance protocol built on
;; Stacks that enables Bitcoin holders to earn rewards and
;; participate in protocol governance through a tiered system.
;;

;; Token Definition & Constants

;; Protocol governance token
(define-fungible-token BITLOCK-TOKEN u0)
...
(define-data-var minimum-stake uint u1000000) ;; Minimum stake amount (1M uSTX = 1 STX)
